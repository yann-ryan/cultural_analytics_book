...
-   [ ] Understand what a join is, and why it needs a common 'key' column
-   [ ] Use `left_join()` to merge two dataframes together
-   [ ] Join on columns which have different names in each dataframe
