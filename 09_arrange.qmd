...
-   [ ] Use `arrange()` to sort a dataframe by one or more columns
-   [ ] Sort in descending order, including for text columns (with `desc()`)
-   [ ] Know how `arrange()` sorts text columns, and why this can look unexpected
