...
-   [ ] Know the difference between a variable, an observation, and a value
-   [ ] Know the difference between wide and long data
-   [ ] Understand what makes data 'tidy'
-   [ ] Use `pivot_longer()` to reshape a wide dataset into a long one
