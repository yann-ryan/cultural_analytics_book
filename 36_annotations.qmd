...
Next we want a curved line with an arrow running from just underneath the text to the middle of the point. To do this, look at the data and find the relevant variables to use as a starting point. The lifeExp (our x axis) for Netherlands is 79.762 and gdpPercap (y axis) is 36797.
...
**Try it yourself:** Create an annotated area which highlights the early nineties recession between 1990 and 1993. Draw a label and an arrow for it. Set a colour, alpha and one other aesthetic value.
