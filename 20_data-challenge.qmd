...
-   The regions contain all the various regional divisions, meaning it has rows for the Netherlands as a whole, one for larger regions, and one for provinces.

The basic cleaning steps are to:

-   Filter the dataset to include only the PV level regional codes (PV = *provincie*, i.e. rows at the province level).
...
-   [ ] Import and inspect a real, messy dataset
-   [ ] Clean and filter a dataset to keep only the rows and columns you need
-   [ ] Reshape a dataset into a tidy, long format
-   [ ] Join in extra information from a second dataset, and export the result
