...
-   [ ] Convert an existing ggplot chart into an interactive one with `ggplotly()`
-   [ ] Know what plotly's interactive features (hover, zoom, legend toggle) add for a viewer
