...
-   [ ] Add a title, subtitle, caption, and axis labels with `labs()`
-   [ ] Relabel an aesthetic (e.g. a legend title) via `labs()`
-   [ ] Use `geom_text()` to label individual data points on a chart
-   [ ] Build a dynamic label with `paste()`
