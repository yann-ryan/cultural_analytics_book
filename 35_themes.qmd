...
It seems like a lot, so let's see how this works with an example. Let's change the **size** of the **x axis title** in the chart we made above (this is the axis label itself, e.g. "lifeExp" - not to be confused with `axis.text`, which controls the tick labels/numbers along the axis).
