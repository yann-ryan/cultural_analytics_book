...
-   [ ] Apply a preset theme (e.g. `theme_light()`) to a chart
-   [ ] Change an individual theme element with `theme()` and the right `element_` function
-   [ ] Rotate and align axis text so long labels are readable
-   [ ] Change text formatting across an entire chart at once
