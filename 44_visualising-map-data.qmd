...
-   A compromise projection doesn't try to be perfectly accurate on any one property (area, angle, or distance) - instead it aims for a reasonable, visually-pleasing balance across all of them. The Winkel Tripel projection above is one example; another is the Robinson projection:
