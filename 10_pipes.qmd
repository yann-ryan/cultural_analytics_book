...
### Checked practice exercises

The exercises below run in your browser and check your code automatically, giving you feedback as you go. They cover everything from this part of the course: `select()`, `slice()`, `arrange()`, and the pipe.
