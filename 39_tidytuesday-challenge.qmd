...
This challenge is where we put the FAIR data and accessibility principles from earlier this session into practice: as you work, keep asking whether your dataset is well-documented and reusable, and whether your finished chart is genuinely accessible to someone using assistive technology.
...
Consider accessibility: choose a suitable colour scheme and adjust theme elements so they are readable.
...
-   How well does this dataset hold up against the FAIR principles - is it Findable, Accessible, Interoperable, and Reusable?
...
-   [ ] Find and download a TidyTuesday dataset with a humanities or cultural focus
-   [ ] Explore and visualise a new, unfamiliar dataset independently
-   [ ] Apply FAIR data and accessibility principles to your own chart
-   [ ] Reflect critically on a dataset's source and its ethical considerations
