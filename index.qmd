...
::: callout-warning
## TODO: confirm block dates for 2025-2026

This edition of the book has been restructured to run as an intensive **6-week block, meeting twice a week (12 sessions total)**, rather than the previous 13-week, once-a-week format. The exact calendar dates for the block still need to be confirmed and filled in throughout this page (Schedule, Reading Schedule) - they're currently left as placeholders.
:::

The course instructor is Dr. Yann Ryan.

This e-book will serve as the course website. The menu on the left side lists the chapters, grouped into one 'part' per week of the course - each week's part contains the chapters for both of that week's sessions. More will appear as the course progresses. The menu on the right contains the table of contents for this particular chapter, so you can skip to different sections. There's a search function just below the title on the left, which students have found very useful when they want to find some code we've discussed and use it later on in an assignment.
...
Your final and most important piece of work will be a *Markdown report:* a publishable document containing code, text, and data visualisations. This report will show off all the skills you have learned during the course.
...
This course now runs as an intensive **six-week block, meeting twice a week** (12 sessions in total), rather than spread over a full semester. Because of this, the pace within each week is faster than it used to be: the two sessions in a week build directly on each other, and any exercises set between them are meant to be done overnight rather than over a full week.

In the first week, you'll learn the very basics using the coding language R and start working with dataframes. Weeks 2 covers the rest of data analysis. Weeks 3 and 4 are a two-week block on data visualisation, wrapping up with Assignment 1. Week 5 covers ethics, FAIR data and accessibility (taught through a hands-on TidyTuesday challenge) before moving into digital mapping, which continues into week 6 alongside a session on R Markdown publication and interactivity, wrapping up with Assignment 2. The **final project** keeps its own longer runway after the taught block ends, rather than being compressed into the six weeks.

| **Week** | **Session** | **Date** | **Topic** | **Assignment** |
|----|----|----|----|----|
| 1 | 1 | TODO | Introductions, tour of the course book, Introduction to R |  |
| 1 | 2 | TODO | R practice, R Markdown, Data Analysis 1: dataframes, selecting and subsetting data |  |
| 2 | 1 | TODO | Data Analysis 2: filtering and changing data |  |
| 2 | 2 | TODO | Data Analysis 3: joins, tidying, summarising and grouping data | Discussion of reading 1. |
| 3 | 1 | TODO | Data Visualisation 1: getting started with R and ggplot2 |  |
| 3 | 2 | TODO | Data Visualisation 2 (part 1): Gestalt principles and scales |  |
| 4 | 1 | TODO | Data Visualisation 2 (part 2): position, date, and colour scales |  |
| 4 | 2 | TODO | Data Visualisation 3: titles, themes, and annotations | **Assignment 1 (create a datavis) due.** |
| 5 | 1 | TODO | Ethics, FAIR data, and accessibility, via the TidyTuesday challenge | Discussion of reading 2. |
| 5 | 2 | TODO | Digital Mapping 1: working with R as a GIS, creating base maps |  |
| 6 | 1 | TODO | Digital Mapping 2 & 3: importing shapefiles, mapping external data, the tmap package |  |
| 6 | 2 | TODO | Publication: R Markdown and interactivity | **Assignment 2 (create a map visualisation) due.** |
|  |  | TODO | Final project due, several weeks after the block ends |  |

: Course Schedule {tbl-colwidths="\[8,8,14,55,15\]" .striped}
...
-   Course readings and coding practice (36 hours)
...
::: callout-warning
## TODO: update for 2025-2026

The official course catalog now lists this course's grading as Participation 10% / Examination 40% / Assignments 50%, with a resit possible for the Final Exam. The percentages below have been updated to match, but the breakdown of the Assignments category, and what the Examination actually covers/consists of, still need to be defined and written up - there's currently no exam-prep material anywhere in this book.
:::
...
::: callout-warning
## TODO: confirm dates for 2025-2026

This reading schedule has been rebuilt to match the new six-week block Course Schedule above, with the two compulsory readings placed alongside the weeks where they're now discussed in-session. The actual calendar dates still need to be filled in once the block dates are confirmed.
:::

+------+----------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Week | **Date** | **Reading**                                                                                                                                                                                                                                                                                                                                                                                                              |
+======+==========+==========================================================================================================================================================================================================================================================================================================================================================================================================================+
| 1    | TODO     | Isabel Mereilles, *Design for Information,* 'Introduction' ([ebook available through Library catalogue](https://catalogue.leidenuniv.nl/permalink/f/n95gpj/UBL_ALMA51257896950002711))                                                                                                                                                                                                                                   |
|      |          |                                                                                                                                                                                                                                                                                                                                                                                                                          |
|      |          | Day, Shawn. (2023) 'Visualising humanities data', in O'Sullivan, J. (ed.) The Bloomsbury Handbook to the Digital Humanities. London: Bloomsbury Publishing, pp. 211-219. (ebook available [through the Library](https://catalogue.leidenuniv.nl/permalink/31UKB_LEU/18s393l/alma9940180698402711) or open access version available [here](https://cora.ucc.ie/bitstreams/1cf13aee-b962-416f-88b5-b8edc0786e7f/download)) |
|      |          |                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
+------+----------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 2    | TODO     | [Edward Tufte, *The Visual Display of Quantitative Information* (Cheshire: 2001)](http://faculty.salisbury.edu/~jtanderson/teaching/cosc311/fa21/files/tufte.pdf): Chapter 1                                                                                                                                                                                                                                             |
|      |          |                                                                                                                                                                                                                                                                                                                                                                                                                          |
|      |          | **Reading 1 (compulsory): D'Ignazio, C., & Klein, L. (2020). '2. Collect, Analyze, Imagine, Teach', in *Data Feminism*. Available at: https://data-feminism.mitpress.mit.edu/pub/ei7cogfn** - discussed in session 2 this week.                                                                                                                                                                                        |
+------+----------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 3    | TODO     | Claus Wilke, *Fundamentals of Data Visualization* (available online). Chapters [2](https://clauswilke.com/dataviz/aesthetic-mapping.html), [3](https://clauswilke.com/dataviz/coordinate-systems-axes.html), and [4](https://clauswilke.com/dataviz/color-basics.html).                                                                                                                                                  |
+------+----------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 4    | TODO     | [Olivia Vane and Rosamund Pearce, 'How to Visualise Sensitive Topics'](https://view.e.economist.com/?qs=f4d0eecea29f1f91774da16cecf280cb31af5fbc06a5916a37f22c049437192916c8af311beed6f52e3ef7e985b7d44f421f783c3fa3272cc08649f97dca80cc14f33497c6a1b1f485f718837a4f7f5a)                                                                                                                                                |
|      |          |                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
|      |          |                                                                                                                                                                                                                                                                                                                                                                                                                          |
|      |          | Read some style guides, e.g. [the Economist](https://design-system.economist.com/documents/CHARTstyleguide_20170505.pdf), [Urban Institute](http://urbaninstitute.github.io/graphics-styleguide/), and https://blog.datawrapper.de/text-in-data-visualizations/                                                                                                                                                          |
+------+----------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 5    | TODO     | **Reading 2 (compulsory): D'Ignazio, C., & Klein, L. (2020). '3. On Rational, Scientific, Objective Viewpoints from Mythical, Imaginary, Impossible Standpoints', in *Data Feminism* (open access, available [here](https://data-feminism.mitpress.mit.edu/pub/5evfe9yd/release/5))** - discussed in session 1 this week.                                                                                            |
|      |          |                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
+------+----------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 6    | TODO     | Claus Wilke, *Fundamentals of Data Visualization* (available online). Chapter [15](https://clauswilke.com/dataviz/geospatial-data.html).                                                                                                                                                                                                                                                                                 |
|      |          |                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
: Weekly Reading Schedule {tbl-colwidths="\[10,15,75\]" .striped}
