...
This week we are going to make a slightly different type of map: a points or dot map. We saw some examples of these [last week](42_digital-mapping-1.qmd#points-map).
...
-   [ ] Read latitude and longitude in both decimal and DMS notation
-   [ ] Know the three main ways to find coordinates for a set of places: manual lookup, gazetteers, and geocoding services
-   [ ] Know when each of those methods is the right one to use
